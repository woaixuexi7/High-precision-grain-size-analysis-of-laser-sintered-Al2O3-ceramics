...
#from backbone import resnext101_fpn_backbone
...
def create_model(num_classes, load_pretrain_weights=True):
    ...
    #backbone = resnext101_fpn_backbone(pretrain_path="resnext101.pth", trainable_layers=3)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--lr-steps', default=[25,50,100], nargs='+', type=int,
